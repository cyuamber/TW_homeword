...
class StatisticsItem extends Component {
    ...
    showAddDialogue = (index) => {
        this.props.showToastFunc(true);
    ...
    render() {
        ...
        const { resourceList, currentItem } = this.state;
            ...
            <div key={index} className="statistics-item">
                ...
                <div className="statistics-item-col">
                    ...
                    <div className="statistics-item-col-operation">
                        <div className="statistics-item-col-operation-plusholder"><i className="icon-plus" onClick={() => this.showAddDialogue(index)}></i></div>
                        {currentItem == index ?
                            <PopupDialogue
                                showIndex={index}
...
StatisticsItem = connect(state => {
    return {
        showDialogue: state.reducer.showDialogue,
    }
}, { showToastFunc: action.showToastFunc })(StatisticsItem)
